...
export function ContactBackground() {
  ...
  return (
    <div ref={containerRef} className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      {/* Gradient orbs */}
      <div className="absolute top-1/4 left-1/3 w-[450px] h-[450px] bg-indigo-600/8 rounded-full blur-[140px] animate-pulse-slow" />
      <div className="absolute bottom-1/4 right-1/3 w-[400px] h-[400px] bg-violet-500/8 rounded-full blur-[120px] animate-pulse-slow animation-delay-2000" />
      ...
      {/* Corner accents */}
      <div className="absolute top-0 left-0 w-[350px] h-[350px] bg-indigo-500/10 rounded-full blur-[120px] animate-pulse-slow" />
      <div className="absolute bottom-0 right-0 w-[350px] h-[350px] bg-violet-500/10 rounded-full blur-[120px] animate-pulse-slow animation-delay-4000" />

      {/* Side glows */}
      <div className="absolute top-1/2 left-0 -translate-y-1/2 w-[250px] h-[400px] bg-indigo-400/6 rounded-full blur-[100px] animate-pulse-slow animation-delay-2000" />
      <div className="absolute top-1/2 right-0 -translate-y-1/2 w-[250px] h-[400px] bg-violet-400/6 rounded-full blur-[100px] animate-pulse-slow animation-delay-4000" />

      {/* Center overlay for text readability */}
      <div
        className="absolute inset-0"
        style={{
          background: "radial-gradient(ellipse 60% 50% at 50% 50%, rgba(10, 8, 20, 0.4) 0%, transparent 70%)",
        }}
      />
    </div>
  );
  ...
  return (
    <div ref={containerRef} className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <div
        className="absolute inset-0"
        style={{
          background: "linear-gradient(180deg, #f8fafc 0%, #f1f5f9 30%, #e2e8f0 60%, #cbd5e1 100%)",
        }}
      />
      ...
      {/* Gradient orbs */}
      <div className="absolute top-1/4 left-1/3 w-[400px] h-[400px] bg-indigo-200/15 rounded-full blur-[120px] animate-pulse-slow" />
      <div className="absolute bottom-1/4 right-1/3 w-[350px] h-[350px] bg-violet-200/12 rounded-full blur-[100px] animate-pulse-slow animation-delay-2000" />

      {/* Corner accents */}
      <div className="absolute top-0 left-0 w-[300px] h-[300px] bg-indigo-300/10 rounded-full blur-[100px] animate-pulse-slow" />
      <div className="absolute bottom-0 right-0 w-[300px] h-[300px] bg-slate-300/15 rounded-full blur-[100px] animate-pulse-slow animation-delay-4000" />

      {/* Top fade */}
      <div
        className="absolute inset-0"
        style={{
          background: "linear-gradient(180deg, rgba(248,250,252,0.8) 0%, transparent 15%)",
        }}
      />
    </div>
  );
