...
export function EcosystemBackground() {
  ...
  useEffect(() => {
    ...
    const waves: Wave[] = [
      ...
      { amplitude: 40, frequency: 0.003, speed: 0.3, phase: 0, yOffset: 0.25, thickness: 0.8, opacityBase: 0.06, colorType: "violet" },
      { amplitude: 35, frequency: 0.004, speed: 0.25, phase: 1.2, yOffset: 0.3, thickness: 0.7, opacityBase: 0.05, colorType: "indigo" },
      { amplitude: 50, frequency: 0.002, speed: 0.35, phase: 2.5, yOffset: 0.35, thickness: 0.9, opacityBase: 0.07, colorType: "cyan" },

      // Mid layer · medium waves
      { amplitude: 30, frequency: 0.005, speed: 0.4, phase: 0.8, yOffset: 0.45, thickness: 1.0, opacityBase: 0.09, colorType: "indigo" },
      { amplitude: 25, frequency: 0.006, speed: 0.45, phase: 2.0, yOffset: 0.5, thickness: 0.9, opacityBase: 0.08, colorType: "violet" },
      { amplitude: 35, frequency: 0.004, speed: 0.38, phase: 3.5, yOffset: 0.55, thickness: 1.1, opacityBase: 0.1, colorType: "cyan" },

      // Front layer · smaller faster waves
      { amplitude: 20, frequency: 0.007, speed: 0.55, phase: 1.5, yOffset: 0.65, thickness: 1.2, opacityBase: 0.12, colorType: "indigo" },
      { amplitude: 18, frequency: 0.008, speed: 0.5, phase: 3.0, yOffset: 0.7, thickness: 1.0, opacityBase: 0.1, colorType: "violet" },
      { amplitude: 25, frequency: 0.006, speed: 0.6, phase: 4.2, yOffset: 0.75, thickness: 1.3, opacityBase: 0.13, colorType: "cyan" },

      // Extra detail waves
      { amplitude: 15, frequency: 0.009, speed: 0.65, phase: 0.5, yOffset: 0.4, thickness: 0.6, opacityBase: 0.05, colorType: "indigo" },
      { amplitude: 45, frequency: 0.0025, speed: 0.2, phase: 1.8, yOffset: 0.6, thickness: 0.7, opacityBase: 0.06, colorType: "violet" },
      { amplitude: 22, frequency: 0.007, speed: 0.5, phase: 2.8, yOffset: 0.8, thickness: 0.8, opacityBase: 0.07, colorType: "cyan" },
    ];
