  ...
  return (
    <section id="about" className="relative pt-36 md:pt-44 pb-24 md:pb-32 overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute top-4 left-6 md:left-12 lg:left-16 z-10 pointer-events-none"
      >
        <motion.div
          animate={{
            y: [0, -18, 0, -8, 0],
      ...
      <motion.div
        ...
        className="absolute top-4 right-6 md:right-12 lg:right-16 z-10 pointer-events-none"
      >
        <motion.div
          animate={{
            y: [0, -15, 0, -10, 0],
