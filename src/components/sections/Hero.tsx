...
export function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center gradient-bg overflow-visible mb-[-48px]">
      ...
      <div className="container-custom relative z-10 pt-44 pb-20">
        <div className="relative flex flex-col items-center text-center gap-6">
          ...
          >
            ...
            {/* Avatar container */}
            <div className="relative w-24 h-24 md:w-28 md:h-28 rounded-full overflow-hidden ring-2 ring-indigo-400/80 ring-offset-4 hero-avatar-ring-offset">
              <Image
                src="/avatar.jpg"
                alt="Andri Amaro"
                width={160}
